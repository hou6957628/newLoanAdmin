<template>
    <div class="content">
      <el-breadcrumb class="fs-16" separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>编辑iconA按钮</el-breadcrumb-item>
      </el-breadcrumb>
...
<script>
  ...
  export default {
    ...
    methods: {
      submitForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            param.append('nameIcon', this.ruleForm.nameIcon);
            param.append('type', 2);
      ...
      goH5(){
        // document.getElementsByClassName(".target").setAttribute("href", window.location.origin + this.ruleForm.h5Url);
        // document.getElementsByClassName(".target").click()
      }
    },
    mounted:function () {
